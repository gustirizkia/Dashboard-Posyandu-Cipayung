...
<div class="card">
    <div class="card-header">
        <div class="row">
            <div class="col">
                <a href="{{ route('imunisasi.create') }}" class="btn btn-success">Tambah Data</a>
            </div>
            <div class="col">
            ...
            <table class="table table-hover table-sm" style="font-size: 12px;">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $item->usia }}</td>
                        <td>{{ \Carbon\Carbon::parse($item->tanggal_imunisasi)->translatedFormat('l, d F Y') }}</td>
                        <td class="text-left d-flex justify-content-between" style="">
                            ...
                            <a href="{{ route('imunisasi.show', $item->id) }}" class="btn btn-info btn-sm">Lihat</a>
                        </td>
                    </tr>
                    @php
                    $no++;
