...
<div class="card">
    <div class="card-header">
        <div class="row">
            <div class="col">
                <a href="{{ route('kematian.create') }}" class="btn btn-success">Tambah Data</a>
            </div>
            <div class="col">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-left d-flex justify-content-between" style="">
                            <a href="{{ route('kematian.edit', $item->id) }}" class="btn btn-warning btn-sm">Edit</a>
                            <form action="{{ route('kematian.destroy', $item->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
                                <button type="submit" onclick="return confirm('Yakin hapus data ini ?')"
                                    class="btn btn-danger btn-sm">Hapus</button>
                            </form>
                            <a href="{{ route('kematian.show', $item->id) }}" class="btn btn-info btn-sm">Lihat</a>
                        </td>
                    </tr>
                    @php
                    $no++;
